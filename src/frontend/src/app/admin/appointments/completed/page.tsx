          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-green-50/70 dark:bg-green-900/30 text-slate-500">
                    <th className="text-left py-3 px-4 font-medium">Biển số xe</th>
                    <th className="text-left py-3 px-4 font-medium">Mã Container</th>
                    <th className="text-left py-3 px-4 font-medium">Tài xế</th>
                    <th className="text-left py-3 px-4 font-medium">Ngày hẹn</th>
                ...
                <tbody>
                  {appointments.map((apt) => (
                    ...
                    >
                      <td className="py-4 px-4 font-medium">{apt.truckPlate}</td>
                      <td className="py-4 px-4 font-mono">{apt.containerNo}</td>
                      <td className="py-4 px-4">{apt.driverName}</td>
