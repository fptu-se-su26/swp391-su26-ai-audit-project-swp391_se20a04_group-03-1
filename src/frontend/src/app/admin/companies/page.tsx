          ...
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="flex w-full md:w-auto items-center gap-3">
              ...
              <Button
                ...
                className="whitespace-nowrap dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
              >
                Xóa bộ lọc
              </Button>
            </div>
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-slate-50/70 dark:bg-slate-900/30 text-slate-500 dark:text-slate-400">
                ...
                <tbody>
                  {companies.map((comp) => (
                    <tr
                      key={comp._id}
                      className="border-b hover:bg-slate-50/50 dark:hover:bg-slate-800/20 dark:border-slate-800 transition-colors"
                    >
                      <td className="py-4 px-4 font-mono font-medium text-slate-900 dark:text-slate-100">
                        {comp.companyCode}
                      </td>
