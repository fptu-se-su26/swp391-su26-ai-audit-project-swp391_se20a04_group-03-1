...
const recentActivity = [
  {
    time: "14:30",
    action: "Xe XE-001 check-in thành công tại Cổng 1",
    status: "Thành công",
  },
  {
    time: "14:25",
    action: "Container CNT-5021 lưu bãi khu A",
    status: "Thành công",
  },
  ...
  {
    time: "14:10",
    action: "Cảnh báo: Bãi khu A gần đạt sức chứa tối đa",
    status: "Cảnh báo",
  },
];
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <p className="text-[#666666] dark:text-[#b3b3b3] mt-2 text-[16px]">
          Cập nhật theo thời gian thực (Real-time). Chào mừng bạn trở lại!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {stats.map((stat) => {
          ...
          return (
            <Card
              key={stat.title}
              className="bg-[#ffffff] dark:bg-[#181818] border-[#e5e5e5] dark:border-[#272727] hover:border-[#1ed760] transition-colors duration-300"
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-[12px] font-bold uppercase tracking-[1.5px] text-[#666666] dark:text-[#b3b3b3]">
                  {stat.title}
                </CardTitle>
                <div
                  className={`${stat.color} rounded-[500px] p-2.5 shadow-sm`}
                >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <Card className="xl:col-span-2 bg-[#ffffff] dark:bg-[#181818] border-[#e5e5e5] dark:border-[#272727]">
          <CardHeader>
            <CardTitle className="text-xl font-bold text-[#121212] dark:text-[#ffffff]">
              Hoạt Động Mới Nhất
            </CardTitle>
            <CardDescription className="text-[#666666] dark:text-[#b3b3b3]">
              Các luồng giao dịch qua cổng trong hôm nay
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-0">
              {recentActivity.map((activity, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between py-4 border-b border-[#e5e5e5] dark:border-[#272727] last:border-0 group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-[14px] text-[#121212] dark:text-[#ffffff] group-hover:text-[#1ed760] transition-colors">
                        {activity.action}
                      </p>
                      <p className="text-[12px] text-[#666666] dark:text-[#999999] mt-1">
                        {activity.time}
                      </p>
                    </div>
                  </div>
                  <span
                    className={`text-[11px] px-3 py-1 font-bold uppercase tracking-wider rounded-[500px] ${
          ...
          <CardContent className="space-y-6">
            <div className="bg-[#f8f8f8] dark:bg-[#121212] p-5 rounded-[12px]">
              ...
              <div className="flex items-end justify-between mt-2">
                <p className="text-3xl font-black text-[#121212] dark:text-[#ffffff]">
                  42
                  <span className="text-lg text-[#666666] dark:text-[#666666]">
                    {" "}
                    lượt
                  </span>
                </p>
      ...
      <Card className="bg-[#ffffff] dark:bg-[#181818] border-[#e5e5e5] dark:border-[#272727]">
        <CardHeader>
          ...
          <CardDescription className="text-[#666666] dark:text-[#b3b3b3]">
            Mức độ lấp đầy container từng phân khu
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={yard.name}
                className="p-5 bg-[#f8f8f8] dark:bg-[#121212] rounded-[16px] border border-[#e5e5e5] dark:border-[#272727]"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <p className="font-bold text-[14px] text-[#121212] dark:text-[#ffffff]">
                    {yard.name}
                  </p>
                </div>
                ...
                <div className="w-full bg-[#e5e5e5] dark:bg-[#272727] rounded-[500px] h-3 mb-3 overflow-hidden">
                  <div
                    className={`${yard.color} h-full rounded-[500px] transition-all duration-1000 ease-out`}
                    style={{ width: `${yard.usage}%` }}
                  />
                </div>
