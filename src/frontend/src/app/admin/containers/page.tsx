...
const containers = [
  { id: 1, number: "CNT-001", type: "20ft", status: "Hàng", location: "A-01-1-1", inDate: "2026-05-15", outDate: null, fee: 0 },
  { id: 2, number: "CNT-002", type: "40ft", status: "Rỗng", location: "A-01-1-2", inDate: "2026-05-16", outDate: null, fee: 0 },
  { id: 3, number: "CNT-003", type: "20ft", status: "Hàng", location: "B-02-2-1", inDate: "2026-05-14", outDate: null, fee: 0 },
  { id: 4, number: "CNT-004", type: "40ft", status: "Rỗng", location: "C-03-1-2", inDate: "2026-05-12", outDate: "2026-05-18", fee: 450000 },
]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600">Quản lý thông tin container trong bãi</p>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-3 px-4 font-medium">Số container</th>
              ...
              <tbody>
                {containers.map((container) => (
                  <tr key={container.id} className="border-b hover:bg-slate-50">
                    <td className="py-3 px-4 font-medium">{container.number}</td>
