...
const yardSlots = [
  { id: 1, block: "A", bay: "01", row: "1", tier: "1", status: "Trống", plate: null },
  { id: 2, block: "A", bay: "01", row: "1", tier: "2", status: "Sử dụng", plate: "XE-001" },
  { id: 3, block: "A", bay: "01", row: "2", tier: "1", status: "Trống", plate: null },
  { id: 4, block: "A", bay: "01", row: "2", tier: "2", status: "Sử dụng", plate: "XE-002" },
  { id: 5, block: "A", bay: "02", row: "1", tier: "1", status: "Trống", plate: null },
  { id: 6, block: "A", bay: "02", row: "1", tier: "2", status: "Sử dụng", plate: "XE-003" },
]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600">Quản lý vị trí đỗ xe và trạng thái bãi</p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
            {yardSlots.map((slot) => (
              ...
              >
                ...
                {slot.plate && (
                  <p className="text-sm font-bold text-green-700 mt-1">{slot.plate}</p>
                )}
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {["Khu A", "Khu B", "Khu C", "Khu D"].map((zone) => (
              <div key={zone} className="p-4 border border-slate-200 rounded-lg">
