...
export default function TrashAppointmentsPage() {
  ...
  const fetchAppointments = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/client/appointments/trash?${params.toString()}`,
        { credentials: "include" },
      );
  ...
  const handleRestoreAppointment = async (id: string) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/client/appointments/restore/${id}`,
        {
          method: "PATCH",
          credentials: "include",
        },
  ...
  const handleHardDeleteAppointment = async (id: string) => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/client/appointments/hard-delete/${id}`,
        {
          method: "DELETE",
          credentials: "include",
        },
