...
export default function ContainersPage() {
 ...
 <th className="px-4 py-3 font-medium text-left font-medium">Loại</th>
 <th className="px-4 py-3 font-medium text-left font-medium">
 Trạng thái
 </th>
 <th className="px-4 py-3 font-medium text-left font-medium">Vị trí</th>
 <th className="px-4 py-3 font-medium text-left font-medium">Ngày vào</th>
 <th className="px-4 py-3 font-medium text-left font-medium">Hành động</th>
 </tr>
 </thead>
 ...
 <td className="px-4 py-3">{container.location}</td>
 <td className="px-4 py-3">{container.inDate}</td>
 <td className="px-4 py-3 flex ga">
